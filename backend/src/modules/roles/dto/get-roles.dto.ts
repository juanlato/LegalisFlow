...
export class GetRolesDto {
  ...
  @ApiPropertyOptional({ example: 'asc', enum: ['asc', 'desc'], description: 'Dirección del ordenamiento' })
  @IsOptional()
  sortOrder?: 'asc' | 'desc';

  @ApiPropertyOptional({ example: 'Administrador', description: 'Filtrar por nombre de rol' })
  @IsOptional()
  @IsString()
  name?: string;

  @ApiPropertyOptional({ example: true, description: 'Filtrar por estado (si aplica)' })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;
