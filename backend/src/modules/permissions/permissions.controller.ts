...
import { CreateModulePermissionsDto } from './dto/create-module-permissions.dto';
  ...
  */
  ...
  export class PermissionsController {
    ...
    @Get()
    //@Roles(RoleEnum.ADMIN, RoleEnum.LAWYER)
    ...
    @ApiOperation({ summary: '[Desarrollo] Crear permisos básicos para un módulo' })
    @ApiResponse({ status: 201, description: 'Permisos creados exitosamente.' })
    async createPermissionsByModule(@Body() dto: CreateModulePermissionsDto): Promise<void> {
